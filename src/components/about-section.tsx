...
export default function AboutSection() {
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className={cn(
        "min-h-dvh py-20 px-4 md:px-6 lg:px-8",
        isVisible
        ...
        <div className="grid md:grid-cols-5 gap-12 items-start">
          ...
          <div className="md:col-span-3 space-y-6">
            <p className="text-muted-foreground leading-relaxed">
              Hi, I'm Vaishnav Wakchaure — a tech enthusiast with a passion for
              system-level development, AI innovations, and cybersecurity. 
            </p>
            <p className="text-muted-foreground leading-relaxed">
            When
              I'm not coding, I'm exploring new technologies, working on secure
              systems, or learning about human behavior and spiritual growth.
            </p>
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {Object.entries(techStack).map(([category, techs]) => (
              <Card
                key={category}
                className="bg-card/50 border-border hover:border-primary transition-colors duration-300"
              >
